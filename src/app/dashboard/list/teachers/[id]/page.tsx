          ...
          <div className="bg-Sky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                <h1 className="text-xl font-semibold">Thiago Pavan</h1>
                {role === "admin" && (
                  <FormModal
                    table="teacher"
                    type="update"
                    data={{
                      id: 1,
                      username: "thiago772000",
                      email: "thiago772000@gmail.com",
                      password: "password",
                      firstName: "Thiago",
                      lastName: "Pavan",
                      phone: "+55 6298645-0130",
                      address: "Av do meu pau, qd 23, lt piroca",
                      bloodType: "A+",
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">Ramos</span>
              </div>
            </div>
